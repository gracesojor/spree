...
describe 'Visiting Products', type: :feature, inaccessible: true do
  ...
  context 'product is on sale', js: true do
    ...
    before do
      ...
      price1.update(pre_sales_amount: '149.99')
      price2.update(pre_sales_amount: '169.99')
      price3.update(pre_sales_amount: '79.99')
      price1.save
      price2.save
      price3.save

      product.master.prices.first.update(pre_sales_amount: 29.99)
